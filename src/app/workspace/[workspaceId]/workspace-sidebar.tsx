...
export const WorkspaceSidebar = () => {
    ...
    if(memberLoading || workspaceLoading){
        return (
            <div className="flex flex-col bg-[#2d3748 ] h-full items-center justify-center">
    ...
    if(!workspace || !member) {
        return (
            <div className="flex flex-col gap-y-2 bg-[#2d3748 ] h-full items-center justify-center">
    ...
    return(
        <div className="flex flex-col bg-[#2d3748 ] h-full">
